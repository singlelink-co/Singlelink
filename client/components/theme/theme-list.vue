<template>
    <div class="flex flex-col w-full justify-center">
        ...
        <div class="flex flex-row flex-wrap mb-2 justify-start w-full">
            ...
            <a v-for="theme in themes" v-if="!icon && active == theme.id" :href="'/dashboard/theme/'+theme.id" class="flex flex-col p-3 flex-1 hover:bg-indigo-200 bg-indigo-200 border border-indigo-600 rounded-lg" style="min-width:215px;max-width:235px;">
            ...
            <!-- List active themes -->
            <a v-for="theme in themes" v-if="!icon && active != theme.id" :href="'/dashboard/theme/'+theme.id" class="flex flex-col p-3 flex-1 hover:bg-gray-200 rounded-lg" style="min-width:215px;max-width:235px;">
                <theme :id="theme.id" :label="theme.label" :colors="theme.colors"/>
            </a>
