        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.pool.query(fs.readFileSync(__dirname + "/../sql/setup-marketplace.sql").toString())];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.pool.query(fs.readFileSync(__dirname + "/../sql/setup-jobs.sql").toString())];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
