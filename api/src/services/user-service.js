...
var UserService = /** @class */ (function (_super) {
    ...
    UserService.prototype.sendPasswordResetEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var user, token, url, params, emailParams, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        url = config_1.config.editorDomain + "/forgot-password/change?";
                            ...
                            Message: {
                                Body: {
                                    Text: {
                                        ...
                                        Data: string_utils_1.StringUtils.parseTemplate(config_1.config.messages.passwordResetEmail.message, { url: url })
                                    }
                                },
                                Subject: {
                                    Charset: config_1.config.messages.passwordResetEmail.subjectCharset,
                                    Data: string_utils_1.StringUtils.parseTemplate(config_1.config.messages.passwordResetEmail.subject, { url: url })
                                }
                            },
