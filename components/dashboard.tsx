        ...
        <div className='flex flex-row min-h-screen w-screen'>
                <div className='flex flex-col h-screen fixed top-0 left-0' style={{ background: '#121212', width: 350, borderRight: 'solid 3px #222222'}}>
                    <div className='flex flex-col'>
                        ...
                        <ul className='m-0 space-y-3 p-8'>
                            <Link href='/dashboard/'>
                                <div className='cursor-pointer p-3 hover:ring-4 hover:ring-opacity-50 hover:ring-indigo-600 rounded-lg hover:bg-indigo-600 flex flex-row items-center justify-start'>
