...
const Dashboard = () => {
    ...
    return (
        <div className='flex flex-row min-h-screen w-screen'>
            ...
            { /* Content */}
            <div className='flex flex-col h-screen fixed top-0 right-0 bg-white' style={{width: 450, borderLeft: 'solid 1px rgba(0,0,0,0.15)'}}>
                ...
                <div className='flex flex-row items-center justify-center text-center p-4 mt-auto' style={{borderTop: 'solid 1px rgba(0,0,0,.15)'}}>
                    Share your Singlelink:
                    <a href="https://beta.singlelink.co" className='ml-2 mr-6 font-semibold text-indigo-600'>beta.singlelink.co</a>
