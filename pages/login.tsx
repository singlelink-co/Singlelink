  ...
  return (
    <div className='flex flex-col items-center justify-center w-full min-h-screen bg-gray-100'>
      ...
      <div className='mb-6' style={{width: 44}}><Logo/></div>
        <h1 className='font-bold text-3xl mb-4'>Login to your Singlelink</h1>
        <p className=' mb-6 text-gray-600'>Enter your credentials to access your account</p>
        <input className='mb-4 px-5 text-lg py-3 rounded-lg border border-gray-200 w-full bg-white focus:ring-4 focus:ring-opacity-50 focus:ring-indigo-600 outline-0 ring-offset-2 focus:border-gray-1' type="password" placeholder="Password"/>
